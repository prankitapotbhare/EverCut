...
export const checkAfterOTPSchema = Joi.object({
    roleType: Joi.string().valid('CUSTOMER', 'BARBER').required(),
});

export const completeCustomerSchema = Joi.object({
...
export const completeBarberSchema = Joi.object({
    phoneNumber: Joi.string().required(),
